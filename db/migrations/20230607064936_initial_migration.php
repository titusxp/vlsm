...
final class InitialMigration extends AbstractMigration
{
    public function up()
    {
       ...
       $sql2 = <<<SQL
        ...
        $this->adapter->execute($sql2);
        $this->adapter->execute($sql3);
        $this->adapter->execute($sql4);
        $this->adapter->execute($sql5);
        $this->adapter->execute($sql6);
        $this->adapter->execute($sql7);
        $this->adapter->execute($sql8);
        $this->adapter->execute($sql9);
        $this->adapter->execute($sql10);
        $this->adapter->execute($sql11);
        $this->adapter->execute($sql12);
        $this->adapter->execute($sql13);
        $this->adapter->execute($sql14);
        $this->adapter->execute($sql15);
        $this->adapter->execute($sql16);
        $this->adapter->execute($sql17);
        $this->adapter->execute($sql18);
        $this->adapter->execute($sql19);
        $this->adapter->execute($sql20);
